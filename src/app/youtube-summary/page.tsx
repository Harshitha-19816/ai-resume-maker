            ...
            <main className="flex-1 overflow-auto">
                <div className="max-w-4xl mx-auto px-6 py-10">
                    <div className="mb-10 text-center">
                        <div className="w-16 h-16 mx-auto mb-6 rounded-2xl bg-gradient-to-br from-red-500/10 to-rose-500/10 flex items-center justify-center">
                    ...
                    {currentSummary && (
                        <div className="glass-card rounded-3xl p-8 mb-10 border border-white/5 bg-gradient-to-br from-slate-900/50 to-slate-800/20">
                            <div className="flex items-center gap-3 mb-6 border-b border-white/5 pb-4">
                                ...
                                <h2 className="text-xl font-bold text-slate-100">Summary Result</h2>
                            </div>
                    ...
                    {summaries.length > 0 && !currentSummary && (
                        <div>
                            <h3 className="text-lg font-semibold text-slate-100 mb-4 px-2">Recent Summaries</h3>
                            <div className="space-y-4">
                                {summaries.map(record => (
                                    <div key={record.id} className="glass-card rounded-2xl p-6 border border-white/5 hover:border-white/10 transition-colors">
                                        ...
                                        <Button
                                            ...
                                            className="mt-4 text-xs text-slate-400 hover:text-white hover:bg-white/5"
                                        >
                                            View Full Summary
                                        </Button>
                                    </div>
