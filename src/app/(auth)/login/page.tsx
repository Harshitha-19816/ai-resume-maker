            ...
            <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
                ...
                <div className="relative flex flex-col justify-center px-16 z-10">
                    ...
                    <h2 className="text-4xl font-bold text-slate-100 leading-tight mb-4">
                        ...
                        <br />
                        <span className="text-violet-400">resume workspace.</span>
                    </h2>
                ...
                <div className="w-full max-w-[420px]">
                    ...
                    <div className="glass-card rounded-2xl p-7 flex flex-col items-center py-10">
                        <div className="text-center mb-6">
                            <h3 className="text-lg font-bold text-slate-100 mb-1">Secure Access</h3>
                            <p className="text-sm text-slate-400">Please sign in with your Google account to continue.</p>
                        </div>
