            ...
            <main className="flex-1 overflow-auto">
                <div className="max-w-5xl mx-auto px-6 py-10">
                    ...
                    <div className="flex items-center justify-between mb-10">
                        <div>
                            <h1 className="text-2xl font-bold text-slate-100 items-center flex gap-3 uppercase tracking-wider">
                        ...
                        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
                            {notes.map((note) => (
                                ...
                                >
                                    ...
                                    <h3 className="font-semibold text-slate-100 text-lg mb-2 pr-8 truncate group-hover:text-emerald-400 transition-colors">
                                        {note.title}
                                    </h3>
